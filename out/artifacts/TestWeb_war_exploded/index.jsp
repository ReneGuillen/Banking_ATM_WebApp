  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto my-2 my-lg-0">
        ...
        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="signup.jsp">Sign Up</a></li>
      </ul>
    </div>
  </div>
</nav>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          ...
          <h1 class="text-uppercase text-white font-weight-bold">Online Banking project</h1>
          <hr class="divider my-4" />
        </div>
        <div class="col-lg-8 align-self-baseline">
          <form action="login" method="post">
          <p class="text-white-75 ">This website provides all features from a real banking system</p>
            <p class="text-white-75">LOGIN</p>
            ...
            <hr class="dividerfinal"/>
          <input class="btn btn-primary btn-xl js-scroll-trigger" type="submit" value="Enter">
          </form>
        </div>
      </div>
    </div>
